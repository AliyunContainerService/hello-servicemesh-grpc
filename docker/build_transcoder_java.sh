...
cd ../docker
docker build -f grpc-server-java.dockerfile -t registry.cn-beijing.aliyuncs.com/asm_repo/grpc_with_api_server_java:1.0.0 .
...
cd ../docker
docker build -f grpc-client-java.dockerfile -t registry.cn-beijing.aliyuncs.com/asm_repo/grpc_with_api_client_java:1.0.0 .
