...
# k exec "$client_node_pod" -c grpc-client-node -n grpc-tracing -- node mesh_client.js grpc-server-svc1.grpc-tracing.svc.cluster.local 6666
# echo "Test from ingressgateway:"
# docker exec -it "$client_node_container" node mesh_client.js ${INGRESS_IP} 6666
